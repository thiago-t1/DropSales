...
-- Amplia valores financeiros de instalações existentes depois de garantir
-- as colunas legadas acima. As tabelas de pagamentos já fazem parte do schema.
ALTER TABLE vendas
...
ALTER TABLE transacoes ALTER COLUMN valor TYPE NUMERIC(19,2);
ALTER TABLE configuracoes_taxa_pagamento ALTER COLUMN taxa_fixa TYPE NUMERIC(19,2);
